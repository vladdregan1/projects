...
public class AfisareActivitateProfesorView extends JFrame{
    ...
    public AfisareActivitateProfesorView() {
    ...
    public void setActivitateList(List<String[]> activitateDetails) {
        ...
        for (String[] details : activitateDetails) {
            String displayText = details[0] + " - " + details[1] + " - " + details[2] + " - " + details[3] + " - " + details[4] + " - " + details[5];
